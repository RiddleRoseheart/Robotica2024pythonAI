        ...
        if results.detections:
            for detection in results.detections:
                ...
                if draw:
                    ...
                    # Extract the score as a float, multiply by 100 to get percentage, and then format it
                    score = detection.score[0] * 100
                    cv2.putText(img, f'{score:.0f}%', (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 255, 0), 2)
        return img
